...
describe("Agent Logic Tests", () => {
  describe("Content Generation Agent", () => {
    it("should generate lecture content with knowledge points", async () => {
  ...
  describe("Exercise Generation Agent", () => {
    it("should generate exercises and answers", async () => {
  ...
  describe("Assessment Agent", () => {
    it("should assess lecture and exercises", async () => {
      const lecture = "# 讲义内容\n\n这是一份完整的讲义。";
